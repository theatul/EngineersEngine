...
<tr>
 ...
 <td><input type="text" name="FName" maxlength="35" value="<?php echo "$FName";?>"/><br /></td>
 </tr>
 <tr>
 <td width="50%" align="left">Last Name:<span class="span">*</span></td>
 <td><input type="text" name="LName" maxlength="35" value="<?php echo "$LName";?>"/></td>
</tr>
...
<select name="Month">
<option value="Jan" <?php if($Month=='Jan'){?> selected="selected"<?php }?>> Jan</option>
<option value="Feb" <?php if($Month=='Feb'){?> selected="selected"<?php }?>> Feb</option>
<option value="Mar" <?php if($Month=='Mar'){?> selected="selected" <?php }?>> Mar</option>
<option value="Apr" <?php if($Month=='Apr'){?> selected="selected"<?php }?>> apr</option>
<option value="May" <?php if($Month=='May'){?> selected="selected" <?php }?>> May</option>
<option value="Jun" <?php if($Month=='Jun'){?> selected="selected"<?php }?>> Jun</option>
<option value="Jul" <?php if($Month=='Jul'){?> selected="selected" <?php }?>> Jul</option>
<option value="Aug" <?php if($Month=='Aug'){?> selected="selected"<?php }?>> Aug</option>
<option value="Sep" <?php if($Month=='Sep'){?> selected="selected" <?php }?>> Sep</option>
<option value="Oct" <?php if($Month=='Oct'){?> selected="selected"<?php }?>> Oct</option>
<option value="Nov" <?php if($Month=='Nov'){?> selected="selected" <?php }?>> Nov</option>
<option value="Dec" <?php if($Month=='Dec'){?> selected="selected"<?php }?>> Dec</option>
...
<option value="31">31</option><option value="<?php echo "$Date";?>"></option>
</select>
&nbsp;&nbsp;&nbsp;
<select name="Year">
...
<td width="50%" align="center"><input type="button" value="<?php echo Cancel;?>" onclick="window.location.href='index.php'"/>  </td>
</tr>
